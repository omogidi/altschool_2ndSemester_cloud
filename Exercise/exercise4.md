...
Submit the content of sources.list and the output of php -v command.
...
<img src="exercise4 images\php.PNG" alt="com command" style="height: 800px; width:1000px;"/>


# Step 2

### Submit the content of sources.list
